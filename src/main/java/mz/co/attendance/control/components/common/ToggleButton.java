...
@CssImport(value = "./themes/attendance-control/vaadin-checkbox.css", themeFor = "vaadin-checkbox")
@SuppressWarnings("serial")
public class ToggleButton extends
        AbstractSinglePropertyField<ToggleButton, Boolean> implements HasStyle, HasTooltip,
