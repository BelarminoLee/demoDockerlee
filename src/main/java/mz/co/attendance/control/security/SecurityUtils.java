...
import mz.co.attendance.control.views.geography.HealthCenterListView;
import mz.co.attendance.control.views.dashbaord.DashboardView;
import mz.co.attendance.control.views.security.CustomRouteNotFoundError;
import mz.co.attendance.control.views.security.AccessDeniedView;
import mz.co.attendance.control.views.security.LoginView;
...
public final class SecurityUtils {
    ...
    public static boolean isAccessGranted(Class<?> securedClass) {
        final boolean publicView = LoginView.class.equals(securedClass)
                ...
                || HealthCenterListView.class.equals(securedClass)
